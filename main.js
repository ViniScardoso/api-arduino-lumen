    ...
    arduino.pipe(new serialport.ReadlineParser({ delimiter: '\r\n' })).on('data', async (data) => {
        ...
        if (HABILITAR_OPERACAO_INSERIR) {
            ...
            if (AMBIENTE == 'producao') {
                ...
                sqlquery = `INSERT INTO registro (medida, dataHoraRgt, fkSensor, fktipo) VALUES (${luminosidade}, CURRENT_TIMESTAMP, 1, 1)`;

                // CREDENCIAIS DO BANCO REMOTO - SQL SERVER
                const connStr = "Server=grupo9-cco.database.windows.net;Database=bdLumen;User Id=lumen700;Password=#Gfgrupo9;";
                ...
                await poolBancoDados.execute(
                    'INSERT INTO registro (medida, dataHoraRgt, fkSensor, fktipo) VALUES (?, now(), 1, 1)',
                    [luminosidade]
                );
                console.log("valores inseridos no banco:" + luminosidade )
